...
class UpdateEmployee(QWidget):
    ...
    def updateEmployee(self):
        ...
        if (name and surname and phone !=""):
            try:
                query="UPDATE employee set Name =?, Surname=?, PhoneNum=?,Email=?,Image=?,Address=? WHERE ID=?"
...
class AddEmployee(QWidget):
    ...
    def addEmployee(self):
        ...
        if (name and surname and phone !=""):
            try:
                query="INSERT INTO employee (Name,Surname,PhoneNum,Email,Image,Address) VALUES(?,?,?,?,?,?)"
